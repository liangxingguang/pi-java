...
| 档 | 范围 | 本次做法 |
|---|---|---|
| **已复核** | `docs/31` 的十九处登记表（§8.2 / §8.3 / §8.6 / §8.7 / §8.9 / §8.15 / §8.18 / §8.19 / §8.21.5 / §8.22.5 / §8.23.5 / §8.24.5 / §8.25.5 / §8.26.5 / §8.27.4 / §8.28.5 / §8.28.7 / §8.29.6） | 逐节读原文核对，带**逐字标记**与行号 |
...
| **B** | **功能缺口**（pi 有、pi-java 无） | 5 | 我（另立包，多数需先出设计文档） |
...
| B2 | compaction **`details` 生产者**恒 null | `docs/31:1324` | pi 填 `readFiles`/`modifiedFiles`（摘要生成路产出）⇒ 并入既有的「`/compact` 命令面复查」 |
